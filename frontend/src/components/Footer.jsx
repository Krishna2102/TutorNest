        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-xl font-bold text-white">TutorNest</h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Connecting students with qualified tutors for personalized learning experiences. 
              Empowering education through technology and expert guidance.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">Find a Tutor</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">Become a Tutor</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">Subjects</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">How It Works</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">Success Stories</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">Tutor Verification</a></li>
              <li><a href="#" className="text-gray-300 hover:text-orange-400 transition-colors">Payment Security</a></li>
